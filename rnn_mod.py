...
import rnn_cell_implement # has modified RNN cell defs alias for internal rnn_cell_impl

# pylint: disable=protected-access
_concat = rnn_cell_implement._concat # modified
_like_rnncell = rnn_cell_implement._like_rnncell # modified
...
def static_rnn(cell,
  ...
  with vs.variable_scope(scope or "rnn") as varscope:
    ...
    for time, (input_, context_) in enumerate(zip(inputs, contexts)): # modified 
      if time > 0:
        varscope.reuse_variables()
      # pylint: disable=cell-var-from-loop
      call_cell = lambda: cell(input_, state, context_) # call to modified RNN cell
